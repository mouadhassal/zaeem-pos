    ...
    <div className="group flex items-center gap-2 py-1.5">
      {photoUrl ? (
        <img
          src={photoUrl}
          alt=""
          className="w-[34px] h-[34px] rounded-[9px] shrink-0 object-cover"
        />
      ) : (
        <div
      ...
      {(onIncrement || onDecrement) && (
        <div className="flex items-center gap-1 shrink-0">
          ...
          {/* Color discipline: this is the one allowed non-logo/nav/pay accent
           * spot -- the "+" of an item already in the cart. */}
          <button
            type="button"
