//! Minimal standard-alphabet base64. Not a security primitive itself
//! (ed25519-dalek does the actual crypto) -- just encoding for the
//! signature/pubkey bytes in the license file.
