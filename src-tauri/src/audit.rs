...
pub enum Action {
    ...
    DiscountApplied,
    /// T2.0 supplier ledger: any CHARGE/PAYMENT fact written to
    /// `supplier_payments`, whether generated by a PO receive or a
    /// standalone `record_supplier_payment_v3` call -- money leaving the
